...
public enum GrammarRuleSpecial implements GrammarRuleSpecialProcessing {
    ...
    CreateTrigStmt(line -> line/*
                     * Adds the CreateTrigStmt to the processCASbits() method to avoid C-style indirections
                     */.replace("processCASbits(", "processCASbits(n, ")
                     .replaceAll("(boolean\\s+dummy)", "$1 = false")),

    alter_generic_option_elem(line -> line/*
                     * $$->field replaced by ((defelt)$).field
                     */.replace("$$->", "((defelt)$$).")),

    TriggerEvents(line -> line/*
    ...
    func_arg_with_default(line -> line/*
    ...
    OptTempTableName(line -> line/*
                     * replace "$$->" by "((range)$$)."
                     */.replace("$$->", "((range)$$).")),

    relation_expr(line -> line/*
                     * replace "$$->" by "((range)$$)."
                     */.replace("$$->", "((range)$$).")),

    GenericType(line -> line/*
                     * replace "$$->" by "((TypeName)$$)."
                     */.replace("$$->", "((TypeName)$$).")),
    ...
    BitWithLength(line -> line/*
                     * replace "$$-&gt;" by "((typeName)$$)."
                     */.replace("char *typname", "String typname")/*
                     * replace "char * typname" by "String typname"
                     */.replace("$$->", "((TypeName)$$).")),

    BitWithoutLength(line -> line/*
                     * replace "$$-&gt;" by "((TypeName)$$)."
                     */.replace("$$->", "((TypeName)$$).")),

    ConstCharacter(line -> line/*
                     * replace "$$->" by "((TypeName)$$)."
                     */.replace("$$->", "((TypeName)$$).")),

    CharacterWithLength(line -> line/*
                     * Type-cast the result
                     */.replace("char *type", "String type").replace("$$->", "((TypeName)$$).")),

    CharacterWithoutLength(line -> line/*
                     * Type-cast the result
                     */.replace("char *type", "String type").replace("$$->", "((TypeName)$$).")),

    ConstDatetime(line -> line/*
                     * replace "$$-&gt;" by "((Iconst)$$)."
                     */.replace("$$->", "((Iconst)$$).")),

    ConstInterval(line -> line/*
                     * replace "$$-&gt;" by "((target)$$)."
                     */.replace("$$->", "((TypeName)$$).")),
    ...
    opt_interval(
            line -> line/*
                     ...
                     */.replaceAll("linitial\\(\\$\\$\\) = (.*)", "((List)\\$\\$).set(0, $1").replace(", @1);",
                    ", @1));")),
    ...
    opt_frame_clause(
            line -> line/*
                     ...
                     */.replace("ING))", "ING)))").replaceAll("(\\()(.*?frameOptions)([^)]*)(\\)?)",
                    "(0 != ($2$3$4$4")),

    frame_extent(
            line -> line/*
                     * Replace C's boolean interpretation of an int by a Java != 0 operator
                     */.replace("_ROW)))", "_ROW))))").replaceAll("(\\()(.*?frameOptions)([^)]*)(\\)?)",
                    "(0 != ($2$3$4$4")),

    qualified_name(line -> line/*
                     * replace "$$-&gt;" by "((RangeVar)$$)."
                     */.replace("$$->", "((RangeVar)$$).")),

    set_rest_more(line -> line/*
