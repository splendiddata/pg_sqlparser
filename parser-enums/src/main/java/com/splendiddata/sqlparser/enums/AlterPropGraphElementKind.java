 ...
 */
public enum AlterPropGraphElementKind {
    PROPGRAPH_ELEMENT_KIND_VERTEX("vertex"),
    PROPGRAPH_ELEMENT_KIND_EDGE("edge");
    ...
    private AlterPropGraphElementKind(String str) {
        STRING_VALUE = str;
    }
    ...
    static {
        ...
        String separator = "";
        for (AlterPropGraphElementKind type : values()) {
