...
/**
 * What to do with nulls in a sort statement, based on Sort by direction, based on
...
public enum SortByNulls {
     ...
     * @param toString
     */
    private SortByNulls(String toString) {
