...
/**
 * Copied from postgresql-15beta3/src/backend/utils/errcodes.h
 *
...
public enum ErrCode {
    ...
    ERRCODE_SQL_JSON_ITEM_CANNOT_BE_CAST_TO_TARGET_TYPE("2203G"),
    ...
    ERRCODE_IDLE_SESSION_TIMEOUT("57P05"),
    ...
    private ErrCode(String sqlstate) {
