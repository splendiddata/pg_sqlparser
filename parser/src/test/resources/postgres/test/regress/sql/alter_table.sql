...
-- Deactivated for SplendidDataTest: ALTER INDEX attmp_idx ALTER COLUMN 0 SET STATISTICS 1000;
...
-- Deactivated for SplendidDataTest: ALTER TABLE attmp3 add constraint attmpconstr foreign key (a) references attmp2 match full NOT VALID;
...
-- Deactivated for SplendidDataTest: alter table atacc1 SET WITH OIDS;
...
-- Deactivated for SplendidDataTest: 10	11	12
-- Deactivated for SplendidDataTest: \.
select * from attest;
copy attest from stdin;
-- Deactivated for SplendidDataTest: 21	22
-- Deactivated for SplendidDataTest: \.
select * from attest;
