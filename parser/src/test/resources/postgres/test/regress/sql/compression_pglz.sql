...
-- Deactivated for SplendidDataTest: CREATE FUNCTION test_pglz_compress(bytea)
-- Deactivated for SplendidDataTest:   RETURNS bytea
-- Deactivated for SplendidDataTest:   AS :'regresslib' LANGUAGE C STRICT;
-- Deactivated for SplendidDataTest: CREATE FUNCTION test_pglz_decompress(bytea, int4, bool)
-- Deactivated for SplendidDataTest:   RETURNS bytea
-- Deactivated for SplendidDataTest:   AS :'regresslib' LANGUAGE C STRICT;
