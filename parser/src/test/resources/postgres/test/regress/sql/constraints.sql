...
-- Deactivated for SplendidDataTest: CREATE TABLE error_tbl (i int DEFAULT (100, ));
--  this will fail because gram.y uses b_expr not a_expr for defaults,
--  to avoid a shift/reduce conflict that arises from NOT NULL being
--  part of the column definition syntax:
-- Deactivated for SplendidDataTest: CREATE TABLE error_tbl (b1 bool DEFAULT 1 IN (1, 2));
...
-- Deactivated for SplendidDataTest: ALTER TABLE unique_tbl ALTER CONSTRAINT unique_tbl_i_key NOT VALID;
