...
-- Deactivated for SplendidDataTest: SELECT INTO tableam_tblselectinto_heap2 USING heap2 FROM tableam_tbl_heap2;

-- CREATE VIEW doesn't support USING
-- Deactivated for SplendidDataTest: CREATE VIEW tableam_view_heap2 USING heap2 AS SELECT * FROM tableam_tbl_heap2;
...
-- Deactivated for SplendidDataTest: CREATE TABLE i_am_a_failure() USING "";
