...
-- Deactivated for SplendidDataTest: CREATE OPERATOR => (
-- Deactivated for SplendidDataTest:    rightarg = int8,
-- Deactivated for SplendidDataTest:    procedure = factorial
...
-- Deactivated for SplendidDataTest: SELECT !=- 10;
