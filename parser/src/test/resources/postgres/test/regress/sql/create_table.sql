...
-- Deactivated for SplendidDataTest: CREATE TABLE unknowntab (
-- Deactivated for SplendidDataTest: 	u unknown    -- fail
-- Deactivated for SplendidDataTest: );

-- Deactivated for SplendidDataTest: CREATE TYPE unknown_comptype AS (
-- Deactivated for SplendidDataTest: 	u unknown    -- fail
-- Deactivated for SplendidDataTest: );
...
-- Deactivated for SplendidDataTest: CREATE TABLE part_bogus_expr_fail PARTITION OF list_parted FOR VALUES IN ('1' collate "POSIX");
