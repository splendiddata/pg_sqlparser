...
-- Deactivated for SplendidDataTest: create event trigger regress_event_trigger2 on ddl_command_start
-- Deactivated for SplendidDataTest:    execute procedure test_event_trigger('argument not allowed');
