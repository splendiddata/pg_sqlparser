...
-- syntax error
-- Deactivated for SplendidDataTest: UPDATE for_portion_of_test2
-- Deactivated for SplendidDataTest:   FOR PORTION OF valid_at
-- Deactivated for SplendidDataTest:     FROM '2013-03-01'::timestamp + INTERVAL '1:02:03' HOUR
-- Deactivated for SplendidDataTest:     TO '2014-01-01'
-- Deactivated for SplendidDataTest:   SET name = 'one^2'
-- Deactivated for SplendidDataTest:   WHERE id = '[1,2)';

-- adding parens fixes it
-- updates [2015-03-01 01:00:00, 2016-01-01) (no minutes)
-- Deactivated for SplendidDataTest: UPDATE for_portion_of_test2
-- Deactivated for SplendidDataTest:   FOR PORTION OF valid_at
-- Deactivated for SplendidDataTest:     FROM ('2015-03-01'::timestamp + INTERVAL '1:02:03' HOUR)
-- Deactivated for SplendidDataTest:     TO '2016-01-01'
-- Deactivated for SplendidDataTest:   SET name = 'one^3'
-- Deactivated for SplendidDataTest:   WHERE id = '[1,2)';
