...
-- Deactivated for SplendidDataTest: ALTER TABLE fktable ALTER CONSTRAINT fktable_fk_fkey ENFORCED NOT ENFORCED;
-- Deactivated for SplendidDataTest: CREATE TEMP TABLE fktable2 (fk int references pktable ENFORCED NOT ENFORCED);
