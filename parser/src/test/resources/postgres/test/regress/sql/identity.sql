...
-- Deactivated for SplendidDataTest: \d itest1_a_seq
...
-- Deactivated for SplendidDataTest: \d itest3
...
TABLE itest8;
-- Deactivated for SplendidDataTest: \d+ itest8
-- Deactivated for SplendidDataTest: \d itest8_f2_seq
-- Deactivated for SplendidDataTest: \d itest8_f3_seq
-- Deactivated for SplendidDataTest: \d itest8_f4_seq
-- Deactivated for SplendidDataTest: \d itest8_f5_seq
DROP TABLE itest8;
