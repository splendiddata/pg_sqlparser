...
-- Errors
--
-- Deactivated for SplendidDataTest: MERGE INTO target t RANDOMWORD
-- Deactivated for SplendidDataTest: USING source AS s
-- Deactivated for SplendidDataTest: ON t.tid = s.sid
-- Deactivated for SplendidDataTest: WHEN MATCHED THEN
-- Deactivated for SplendidDataTest:	UPDATE SET balance = 0;
-- MATCHED/INSERT error
-- Deactivated for SplendidDataTest: MERGE INTO target t
-- Deactivated for SplendidDataTest: USING source AS s
-- Deactivated for SplendidDataTest: ON t.tid = s.sid
-- Deactivated for SplendidDataTest: WHEN MATCHED THEN
-- Deactivated for SplendidDataTest: 	INSERT DEFAULT VALUES;
-- incorrectly specifying INTO target
-- Deactivated for SplendidDataTest: MERGE INTO target t
-- Deactivated for SplendidDataTest: USING source AS s
-- Deactivated for SplendidDataTest: ON t.tid = s.sid
-- Deactivated for SplendidDataTest: WHEN NOT MATCHED THEN
-- Deactivated for SplendidDataTest: 	INSERT INTO target DEFAULT VALUES;
-- Multiple VALUES clause
-- Deactivated for SplendidDataTest: MERGE INTO target t
-- Deactivated for SplendidDataTest: USING source AS s
-- Deactivated for SplendidDataTest: ON t.tid = s.sid
-- Deactivated for SplendidDataTest: WHEN NOT MATCHED THEN
-- Deactivated for SplendidDataTest: 	INSERT VALUES (1,1), (2,2);
-- SELECT query for INSERT
-- Deactivated for SplendidDataTest: MERGE INTO target t
-- Deactivated for SplendidDataTest: USING source AS s
-- Deactivated for SplendidDataTest: ON t.tid = s.sid
-- Deactivated for SplendidDataTest: WHEN NOT MATCHED THEN
-- Deactivated for SplendidDataTest: 	INSERT SELECT (1, 1);
-- NOT MATCHED/UPDATE
-- Deactivated for SplendidDataTest: MERGE INTO target t
-- Deactivated for SplendidDataTest: USING source AS s
-- Deactivated for SplendidDataTest: ON t.tid = s.sid
...
-- Deactivated for SplendidDataTest: ON t.tid = s.sid
-- Deactivated for SplendidDataTest: WHEN MATCHED THEN
-- Deactivated for SplendidDataTest: 	UPDATE target SET balance = 0;
...
BEGIN;
INSERT INTO sq_source (sid, balance, delta) VALUES (-1, -1, -10);
-- Deactivated for SplendidDataTest: MERGE INTO sq_target t
-- Deactivated for SplendidDataTest: USING v
-- Deactivated for SplendidDataTest: ON tid = sid
-- Deactivated for SplendidDataTest: WHEN MATCHED AND tid > 2 THEN
-- Deactivated for SplendidDataTest:     UPDATE SET balance = t.balance + delta
-- Deactivated for SplendidDataTest: WHEN NOT MATCHED THEN
-- Deactivated for SplendidDataTest: 	INSERT (balance, tid) VALUES (balance + delta, sid)
-- Deactivated for SplendidDataTest: WHEN MATCHED AND tid < 2 THEN
-- Deactivated for SplendidDataTest: 	DELETE
-- Deactivated for SplendidDataTest: RETURNING *;
ROLLBACK;
