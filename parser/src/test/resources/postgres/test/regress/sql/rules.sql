...
select * from rtest_v1;
-- Deactivated for SplendidDataTest: ** Remember the delete rule on rtest_v1: It says
-- Deactivated for SplendidDataTest: ** DO INSTEAD DELETE FROM rtest_t1 WHERE a = old.a
-- Deactivated for SplendidDataTest: ** So this time both rows with a = 2 must get deleted
\p
\r
delete from rtest_v1 where b = 12;
select * from rtest_v1;
...
-- Deactivated for SplendidDataTest: \d+ rule_t1
