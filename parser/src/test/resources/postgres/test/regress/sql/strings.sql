...
-- Deactivated for SplendidDataTest: SELECT 'first line'
-- Deactivated for SplendidDataTest: ' - next line' /* this comment is not allowed here */
-- Deactivated for SplendidDataTest: ' - third line'
-- Deactivated for SplendidDataTest: 	AS "Illegal comment within continuation";
...
-- Deactivated for SplendidDataTest: SELECT U&'wrong: \+2FFFFF';

-- while we're here, check the same cases in E-style literals
SELECT E'd\u0061t\U00000061' AS "data";
SELECT E'a\\b' AS "a\b";
-- Deactivated for SplendidDataTest: SELECT E'wrong: \u061';
-- Deactivated for SplendidDataTest: SELECT E'wrong: \U0061';
-- Deactivated for SplendidDataTest: SELECT E'wrong: \udb99';
-- Deactivated for SplendidDataTest: SELECT E'wrong: \udb99xy';
-- Deactivated for SplendidDataTest: SELECT E'wrong: \udb99\\';
-- Deactivated for SplendidDataTest: SELECT E'wrong: \udb99\u0061';
...
-- Deactivated for SplendidDataTest: select 'a\\bcd' as f1, 'a\\b\'cd' as f2, 'a\\b\'''cd' as f3, 'abcd\\'   as f4, 'ab\\\'cd' as f5, '\\\\' as f6;
