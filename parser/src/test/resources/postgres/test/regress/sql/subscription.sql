...
-- Deactivated for SplendidDataTest: CREATE SUBSCRIPTION regress_testsub CONNECTION 'foo';

-- fail - no connection
-- Deactivated for SplendidDataTest: CREATE SUBSCRIPTION regress_testsub PUBLICATION foo;
