...
-- Deactivated for SplendidDataTest: CREATE SUBSCRIPTION testsub CONNECTION 'foo';

-- fail - no connection
-- Deactivated for SplendidDataTest: CREATE SUBSCRIPTION testsub PUBLICATION foo;
