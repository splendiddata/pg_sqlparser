...
-- Deactivated for SplendidDataTest: create table foo (with baz);  -- fail, WITH is a reserved word
-- Deactivated for SplendidDataTest: create table foo (with ordinality);  -- fail, WITH is a reserved word
-- Deactivated for SplendidDataTest: with ordinality as (select 1 as x) select * from ordinality;
